...
<tr> 
<td colspan="2" class="contentHeader1" align="left">&Oslash;ko-net Sj&aelig;lland </td>
</tr>
<tr> 
...
<tr> 
  <td><h3>Region  Sj&aelig;lland</h3>
  Bestyrelsen:<br>
    <br>
    <strong>Jean Fischer</strong><br>
    Kultursociolog<br>
    <br>
    <strong>Astrid Dahl</strong><br>
    Stud. Tek-Sam, RUC<br>
    <br>
    <strong>Ella Hilker</strong><br>
    Konsulent
    <p>Kontakt:<br>
      e-mail: <a href="mailto:sjaelland@eco-net.dk">sjaelland@eco-net.dk</a><br>
      tlf.: 62 24 43 24 (&Oslash;ko-nets landssekretariat) </p>
    <p><a href="sjaelland_vedt.asp">Vedt&aelig;gter</a></p>    
    <h2>&nbsp;</h2>
    </td>
</tr>
<tr> 
