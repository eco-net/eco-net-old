    ...
    <tr>
      <td valign="top">
        <table width="100%" border="0" cellspacing="0" cellpadding="0" background="/shared/graphics/spacer.gif" name="detailContents">
          <tr>
            <td colspan="2" class="contentHeader1" align="left"> Bestyrelse</td>
          </tr>
          <tr>
...
%>
                      <p><span class="listheader"><%=(rsPageData.Fields.Item("navn").Value)%><br>
                        ...
                        <a href="mailto:<%=(rsPageData.Fields.Item("email").Value)%>"><%=(rsPageData.Fields.Item("email").Value)%> </a><br>
                        <%=(rsPageData.Fields.Item("telefon").Value)%></p>
                      <% 
