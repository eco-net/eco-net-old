<html><!-- #BeginTemplate "/Templates/blog.dwt" --><!-- DW6 -->
<head>
<!-- #BeginEditable "doctitle" --> 
<title>&oslash;ko-Net</title>
<!-- #EndEditable --> 
...
<table width="800" border="0" cellspacing="0" cellpadding="0" align="center" name="Pagetable">
<tr> 
<td background="/shared/graphics/layout/dots_vert.gif" width="1" valign="top"><img src="/shared/graphics/layout/cover_dots.gif" width="1" height="18"></td>
<td width="800" valign="top"><table width="800" border="0" cellspacing="0" cellpadding="0" name="Header">
<tr> 
<td valign="top" rowspan="3"><img src="/shared/graphics/logo4.gif" width="569" height="31"> 
<table width="569" border="0" cellpadding="0" cellspacing="0" align="left">
<tr>
<td width="8"><br></td>
...
<!-- END HEADER -->
<!-- #BeginEditable "menu" -->
<table width="800" border="0" cellspacing="0" cellpadding="0" name="Menu">
<tr>
<%
'-- tab1 -- NYHEDER
...
'response.write "<img src=""/shared/graphics/menu/separator.gif"" width=""29"" height=""22"">"
response.write "<img src=""/shared/graphics/menu/stretch.gif"" width=""70"" height=""22""></td></tr>"
%>
<%IF curtab>0 THEN%>
<tr><td class="menuBar">
<%
...
</tr></table><!-- #EndEditable --> 
<table width="800" border="0" cellspacing="0" cellpadding="0" name="Contentarea">
<tr> 
<td height="" valign="top" name="blog"><!-- #BeginEditable "blog" -->
<iframe 
